...
public:
	...
	bool _stdcall init(CampTypes camp, UnitTypes types, GridVec2 coord,
...
public:
	...
	bool _stdcall init(CampTypes camp, UnitTypes fightType, GridVec2 point, TMXTiledMap* map, GridMap *gridmap, int id = 0);
	void shootBullet();
	void attack();
	void attackUpdate(float dt);
	void startAttackUpdate();
...
class AttackDog :public FightUnit
{
public:
	static AttackDog* AttackDog::create(const std::string &filename);
	bool _stdcall init(CampTypes camp, UnitTypes fightType, GridVec2 point, TMXTiledMap* map, GridMap *gridmap, int id = 0);
	void attack();
	void attackUpdate(float dt);
	void startAttackUpdate();
